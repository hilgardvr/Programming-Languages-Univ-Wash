...
l2 = Let.new("a", LineSegment.new(-1, -2, 3, 4), Let.new("b", LineSegment.new(3,4,-1,-2), Intersect.new(Var.new("a"),Var.new("b"))))
l2 = l2.preprocess_prog.eval_prog([["a",Point.new(0,0)]])
if not (l2.x1 == -1 and l2.y1 == -2 and l2.x2 == 3 and l2.y2 == 4)
	puts "Let eval_prog should evaluate e2 after adding [s, e1] to the environment"
end
